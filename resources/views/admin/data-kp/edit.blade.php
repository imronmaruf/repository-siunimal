                ...
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Data Kerja Praktek</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="page-title">Edit Data Kerja Praktek</h3>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('data-kp.update', $dataKp->id) }}" method="POST"
                                ...
                                @can('admin-only')
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select id="mahasiswa_id" name="mahasiswa_id"
                                            ...
                                            @foreach ($mahasiswas as $mahasiswa)
                                                <option value="{{ $mahasiswa->id }}" data-nim="{{ $mahasiswa->nim }}"
                                                    ...
                                                    {{ old('mahasiswa_id', $dataKp->mahasiswa_id) == $mahasiswa->id ? 'selected' : '' }}>
                                                    {{ $mahasiswa->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <input type="hidden" id="dosen_pembimbing" name="dosen_pembimbing"
                                            value="{{ old('dosen_pembimbing', $dataKp->dosen_pembimbing) }}">
                                    </div>
                                @else
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea id="judul_kp" name="judul_kp" rows="3" class="form-control @error('judul_kp') is-invalid @enderror"
                                        placeholder="Enter text here">{{ old('judul_kp', $dataKp->judul_kp) }}</textarea>
                                    @error('judul_kp')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea id="latar_belakang" name="latar_belakang" rows="5"
                                        class="form-control @error('latar_belakang') is-invalid @enderror" placeholder="Enter text here">{{ old('latar_belakang', $dataKp->latar_belakang) }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="link_github" name="link_github" type="text"
                                        ...
                                        value="{{ old('link_github', $dataKp->link_github) }}">
                                    @error('link_github')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input id="link_gdrive" name="link_gdrive" type="text"
                                        ...
                                        value="{{ old('link_gdrive', $dataKp->link_gdrive) }}">
                                    @error('link_gdrive')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
