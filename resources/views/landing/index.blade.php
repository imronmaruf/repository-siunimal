            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="service-item">
                        <div class="icon">
                            <img src="{{ asset('landings/assets/images/service-01.png') }}" alt="online degrees">
                        </div>
                        <div class="main-content">
                            <h4>Repository Kerja Praktek</h4>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="service-item">
                        <div class="icon">
                            <img src="{{ asset('landings/assets/images/service-02.png') }}" alt="short courses">
                        </div>
                        <div class="main-content">
                            <h4>Repository Tugas Akhir</h4>
                ...
                {{-- <div class="col-lg-4 col-md-6">
                    <div class="service-item">
                        <div class="icon">
                            <img src="{{ asset('landings/assets/images/service-03.png') }}" alt="web experts">
                        </div>
                        <div class="main-content">
                            <h4>Web Experts</h4>
